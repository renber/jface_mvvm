...
/**
 * Based on JFace's original ObservableListContentProvider Version from
 ...
 *
 */
public class AutoObservableListContentProvider implements
	...
	private static class Impl extends ObservableCollectionContentProvider
		...
		protected void addCollectionChangeListener(
			...
			if (collection != null && collection instanceof IChildChangeObservable)
				((IChildChangeObservable)collection).addChildChangeListener(this);
		}
		...
		protected void removeCollectionChangeListener(
			...
			if (collection != null && collection instanceof IChildChangeObservable)
				((IChildChangeObservable)collection).removeChildChangeListener(this);
		}
	 ...
	 * display thread.
	 */
	public AutoObservableListContentProvider() {
		this(null);
	}
	 ...
	 * @since 1.3
	 */
	public AutoObservableListContentProvider(IViewerUpdater viewerUpdater) {
